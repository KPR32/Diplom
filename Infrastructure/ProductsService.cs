...
namespace FurnitureStore3.Infrastructure
{
    public class ProductsService : IProductsService
    {
        ...
        public ProductsService(IRepository<Product> products, IRepository<PriceStory> priceStorys)
        {
        ...
        public async Task AddPriceStory(PriceStory priceStory)
        {
            await priceStorys.AddAsync(priceStory);
        }
