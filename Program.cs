...
builder.Services.AddScoped<IRepository<PriceStory>, EFRepository<PriceStory>>();
builder.Services.AddScoped<IRepository<CompleteOrder>, EFRepository<CompleteOrder>>();
...
app.MapControllerRoute("default", "{Controller=Products}/{Action=Info}");
